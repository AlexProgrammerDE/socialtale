      ...
      <>
        ...
        <Layout>
          <div className="container flex-grow p-1 md:p-6 prose">
            <h1>Privacy Policy for Socialtale</h1>

            <p>
              At Socialtale, accessible from https://socialtale.net, one of
              our main priorities is the privacy of our visitors. This Privacy
              Policy document contains types of information that is collected and
              recorded by Socialtale and how we use it.
            </p>
            ...
            <p>
              Socialtale legal basis for collecting and using the personal
            ...
            <ul>
              <li>Socialtale needs to perform a contract with you</li>
              <li>You have given Socialtale permission to do so</li>
              <li>
                Processing your personal information is in Socialtale legitimate
                interests
              </li>
              <li>Socialtale needs to comply with the law</li>
            </ul>

            <p>
              Socialtale will retain your personal information only for as long as
            ...
            <p>
              Socialtale follows a standard procedure of using log files. These
            ...
            <p>
              Like any other website, Socialtale uses &apos;cookies&apos;. These
            ...
            <p>
              ...
              advertising partners of Socialtale.
            </p>

            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on Socialtale, which
            ...
            <p>
              Note that Socialtale has no access to or control over these cookies
            ...
            <p>
              Socialtale&apos;s Privacy Policy does not apply to other advertisers
            ...
            <p>
              Socialtale does not knowingly collect any Personal Identifiable
            ...
            <p>
              ...
              Socialtale. This policy is not applicable to any information
